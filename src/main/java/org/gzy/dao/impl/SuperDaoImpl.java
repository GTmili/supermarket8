...
public class SuperDaoImpl extends BaseDao implements SuperDao {
    //登录
    public Userinfo isLogin(Userinfo userinfo) throws SQLException, InstantiationException, IllegalAccessException, NoSuchFieldException {
...
public List<Userinfo> all(Object... param) throws Exception {
        ...
        if (param.length==0) {
            ...
            Object [] objects = {"%"+param[0]+"%"};
            list = this.excuteMoreQuery(sql,Userinfo.class,objects);
        }
    return list;
}
}
